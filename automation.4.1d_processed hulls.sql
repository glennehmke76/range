...
INSERT INTO processed_hulls_tmp (hull_type, regionalisation, sp_id, taxon_id_r, class, geom, permutation)
SELECT
  hull_type,
  regionalisation,
  sp_id,
...
INSERT INTO processed_hulls (hull_type, regionalisation, sp_id, taxon_id_r, class, geom, permutation)
SELECT
