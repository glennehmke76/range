DROP PROCEDURE IF EXISTS r_create_regions_spc_methods;
CREATE OR REPLACE PROCEDURE r_create_regions_spc_methods(
  p_sp_id INTEGER,
...
-- CALL r_create_regions_spc_methods(
--   p_sp_id := 214,
--   p_start_year := 1999,
--   p_end_year := 2023,
--   p_survey_types := ARRAY[0,1,2,3,4,5,6,7,8],
--   p_region_suffix := 'grid_100km'
-- );